...
train = pd.read_csv("/home/shang/datasets/house_prices/train.csv")
test = pd.read_csv("/home/shang/datasets/house_prices/test.csv")
...
def k_fold_cross_valid(k, epoch, verbose_epoch, X_train, y_train, learning_rate, weight_decay):
	assert k > 1
